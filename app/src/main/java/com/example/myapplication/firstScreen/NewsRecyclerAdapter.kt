 ...
 */
class NewsRecyclerAdapter(val list: MutableList<News>, val activity: Activity, val listener: (News)->Unit): RecyclerView.Adapter<NewsRecyclerAdapter.NewsViewHolder>() {
